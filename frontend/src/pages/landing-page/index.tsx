  ...
  return (
    <div>
      <div className="flex right-6 top-6 gap-6 absolute">
        ...
        <Link to="/register">
          <Button className="rounded-full text-background hover:bg-primary/70 hover:border-background border border-primary px-6 py-5 text-md">
            Rejestracja
          </Button>
        </Link>
      </div>
      <div className="w-full h-screen bg-background gap-8 flex flex-col justify-center items-center">
        ...
        <div className="w-full flex flex-col justify-start items-center gap-12">
          ...
          <h1 className="lg:text-2xl !text-xl text-muted-foreground text-wrap text-center w-3/4 !font-['Poppins']">
            ...
            dostosowuje Twój harmonogram do zmieniających się potrzeb i
            wykonanych zadań.
          </h1>
        </div>
        <Link
        ...
        >
          <Button
            className="relative rounded-full border-2  text-primary border-primary text-xl hover:border-foreground !px-6 !py-6 bg-opacity-0 bg-[radial-gradient(circle,_rgba(170,121,246,0.4)_0%,_transparent_100%)] bg-no-repeat bg-center bg-[length:0px_100%] hover:bg-[length:100%_100%] hover:bg-transparent hover:text-primary hover:!px-8 transition-all duration-300"
            variant="outline"
          >
